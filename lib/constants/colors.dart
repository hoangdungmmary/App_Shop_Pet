...
class AppColors{
  ...
  static Color homePageSutitle = const Color(0xFF414160);
  ...
  static Color secondPageContainerGradient1stColor= const Color(0xff0092ED);
  static Color secondPageContainerGradient2stColor= const Color(0xff24A0ED);
