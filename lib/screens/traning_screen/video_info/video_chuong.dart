...
class VideoRengs extends StatefulWidget {
  const VideoRengs({Key? key}) : super(key: key);

  @override
  State<VideoRengs> createState() => _VideoRengsState();
}

class _VideoRengsState extends State<VideoRengs> {
  List videoinfo = [];
  ...
  _initDatat() async{
    await DefaultAssetBundle.of(context).loadString("assets/json/video_chuong.json").then((value) =>{
      setState((){
