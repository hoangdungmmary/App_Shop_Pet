...
class VideoHands extends StatefulWidget {
  const VideoHands({Key? key}) : super(key: key);

  @override
  State<VideoHands> createState() => _VideoHandsState();
}

class _VideoHandsState extends State<VideoHands> {
  List videoinfo = [];
  ...
  _initDatat() async{
    await DefaultAssetBundle.of(context).loadString("assets/json/video_battay.json").then((value) =>{
      setState((){
