...
class VideoVS extends StatefulWidget {
  const VideoVS({Key? key}) : super(key: key);

  @override
  State<VideoVS> createState() => _VideoVSState();
}

class _VideoVSState extends State<VideoVS> {
  List videoinfo = [];
  ...
  _initDatat() async{
    await DefaultAssetBundle.of(context).loadString("assets/json/video_vs.json").then((value) =>{
      setState((){
